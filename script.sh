...
UpFileSize=$(( ( RANDOM % 1000 ) +500 ))M   # Upload file's size:
                                            # generated randomly between 500MB and 1500MB.
...
BwLimit=$(( ( RANDOM % 2000 ) +700 ))   # Bandwidth limit:
                                        # generated randomly between 700KBps and 2700KBps.
